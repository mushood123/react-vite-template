      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white border border-gray-200 p-4 rounded-lg">
            ...
            <div className="space-y-1 text-sm">
              <p>
                <code className="bg-gray-200 px-2 py-1 rounded">npm run lint</code> - Check linting
              </p>
              <p>
          ...
          <div className="bg-white border border-gray-200 p-4 rounded-lg">
            ...
            <div className="space-y-1 text-sm">
              <p>
                <code className="bg-gray-200 px-2 py-1 rounded">npm run format</code> - Format code
              </p>
              <p>
                <code className="bg-gray-200 px-2 py-1 rounded">npm run format:check</code> - Check
                formatting
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <p>
              ...
              <code className="bg-gray-200 px-2 py-1 rounded">
                import {(get, post, put, patch, del)} from &apos;./api&apos; &apos;./endpoints&apos;
              </code>
            </p>
          </div>
        </div>
